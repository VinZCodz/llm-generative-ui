...
export const evaluateAgent = async (input: string, dbData: any, response: string) => {
    const prompt = `
    ...
    Criteria: Does the response accurately reflect the DB record and answer the user?
